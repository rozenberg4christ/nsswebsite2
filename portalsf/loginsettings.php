...
{
$update=mysql_query("UPDATE tbl_login SET log_status='Y' where log_status='N'");
echo'<script language=javascript>window.location.href="loginsettings.php"</script>';
}
...
<script type="text/javascript">
	T$('testclick1').onclick = function(){TINY.box.show('popup.php',1,800,415,1)}
						...
						?>
												...
												<input type="button" name="add" id="add" value="Add User" onclick="window.location.href='#';" />

...
-->
  ...
  <tr>
    <td><ul>
	  <p class="style16">Instructions for Filling the College Details Form </p>
		  <li class="style13">
      ...
      <div align="justify"><br/>
		...
		<p class="style16">Instructions for Filling PO Details Form </p>
		<li class="style13">
        <div align="justify">Fill the approved number of PO details.</div>
      </li> 
      <div align="justify"><br/>
        </div>
		<li class="style13">
        <div align="justify">Don't enter number of PO details beyond your PO limits. Size of your PO limit is mentioned in respective page. </div>
      </li> 
      <div align="justify"><br/>
        </div>
			<li class="style13">
        <div align="justify">If you entered as wrongly, edit option is possible by using pencil icon. After editing save the data using save icon. </div>
      </li> 
      <div align="justify"><br/>
        </div>
			<li class="style13">
        <div align="justify">Try to avoid to use remove icon. This icon is only given for remove addtional data entered by accidentaly in rare situation. </div>
      </li> 
      <div align="justify"><br/>
        </div>
    </ul></td>

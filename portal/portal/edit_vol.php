...
{
$update=mysql_query("update volunteer set status='".$_REQUEST['status']."' where id='".$logid."'")or die(mysql_error());
echo'<script language=javascript>window.location.href="vol_settings.php?msg=Success"</script>';
}
require("header.php");
$query=mysql_query("select * from volunteer where id='".$logid."'") or die(mysql_error());

    ...
    <td><ul>
	  ...
	  <p class="style16">Instructions for filling Activities Participated form (For both Funded & Self Financing Unit) </p>
	   ...
	   <p class="style16">Instructions for filling PO Details form (For both Funded & Self Financing Unit) </p>
		  <div class="style13"><div align="justify">Fill the PO details of your College using respective menu available in the left menu bar. <br/>
		    Approved nos. of PO of your College is given in the top of respective page. <br/>
		  </div>
      </div> 
      ...
      <div class="style13">
		...
		<div class="style13">
        <div align="justify">Fill the Volunteers details of your College using respective menu available in the left menu bar. <br/>Make sure that you are entered valid data. <br/> Once you are submited the form you cannot edit the form.		</div>
      </div> 
	  
	  <p class="style16">Instructions for Filling Special Camp Details Form (For Funded Unit only) </p>
		<div class="style13">
        <div align="justify">Fill the Special Camp details of your College using respective menu available in the left menu bar. <br/>Make sure that you are entered valid data. <br/> Once you are submited the form you cannot edit the form.		</div>
      </div> 
